...
Start longitude = -94.5932 Start latitude = 37.0524 End longitude = -94.2213 End latitude = 36.9838 crs = geographic number of fatalities = 158
...
Geo-computations on simple features involve the geometry engine-open source (GEOS).
...
Each column variable gets plotted up to some maxima.

Before doing geo-computations we should set the coordinate reference system including the spatial units. Here we transform the geographic coordinate reference system to a specific Lambert conic conformal (planar) projection with units of kilometers.
```{r}
