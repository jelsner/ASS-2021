...
In this class we use functions from the {sf} package to work with vector data and functions in the {raster} packages to work with raster data sets. We will also look at functions from the {stars} package that work with both vector and raster data models.
