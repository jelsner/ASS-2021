...
S4 spatial data objects and working with rasters in R.

## Spatial data frames in the S4 class of data objects

The {sp} package has methods for working with spatial data. Several of the packages for analyzing and modeling spatial data we will use this semester depend on {sp}.
