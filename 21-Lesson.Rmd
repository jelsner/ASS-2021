...
Today: This will be the final lesson on point pattern data analysis and modeling. I will show two examples from my research on tornadoes. Friday's assignment (Assignment 9) will be to write a short paragraph (5 or 6 sentences) describing your research interest as it relates to spatial statistics. You will write the paragraph in the Rmd file. I will give you a rubric and an example. I will post it to Canvas today and it is due on Friday (March 26) at 3p. I will not be available for Zoom Friday morning.
