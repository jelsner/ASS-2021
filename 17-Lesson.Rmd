...
Quantifying the reporting bias is straightforward for tornadoes in Kansas since there is no trend in the local intensity. That is, there are no large gradients in the number of reports as we move across different regions of the state.
