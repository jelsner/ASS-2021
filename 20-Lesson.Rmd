...
We start by investigating the event interaction using a Strauss model with interaction radius of .019 units (18 ft).
```{r}
ppm(MT, trend = ~ 1, 
        interaction = Strauss(r = .019))
```

Here the first order term beta is 345. It is the 'latent' rate of maple trees per unit area. This rate is less than the 514 actual maple trees. The fitted interaction parameter (gamma) is 1.72. It is greater than one since the trees are clustered. The logarithm of gamma is positive at .545.
