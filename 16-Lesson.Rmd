...
## Can the tornado events be adequately described by a model of complete spatial randomness?

Here we are interested in the intensity of tornado genesis locations in Kansas. Import the data as a simple features data frame and transform the geographic CRS to a web Mercator. Here we get all the tornadoes since 1950 with a EF damage rating.
```{r}
library(tidyverse)
library(sf)
