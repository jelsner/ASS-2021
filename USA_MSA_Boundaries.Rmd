...
Was not able to download it from home. I was at work.
```{r}
...
ggplot(Both) +
  ...
  ggtitle(label = "The shifting tornado threat", 
          subtitle = "Top ten increases and decreases in the number of strong (EF2+) tornadoes\nwithin metropolitan areas before and after 1985")
```
