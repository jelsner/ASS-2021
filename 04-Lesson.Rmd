...
Schedule for posting lessons/assignments
...
Let's look at some of the {dplyr} functions to see how they operate on the data frame `airquality`.
...
Let's look at some examples from my research.
