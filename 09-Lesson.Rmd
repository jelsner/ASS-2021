...
This example covers a multiband raster taken from a Landsat 7 view of a small part of the Brazilian coast. We begin by reading a GeoTIFF file using three array dimensions, two planar space, and the third across six bands.
```{r}
library(stars)

fn <- system.file("tif/L7_ETMs.tif",
                  package = "stars")
( L7.st <- read_stars(fn) )
```
