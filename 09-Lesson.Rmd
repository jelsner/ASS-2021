...
A cartogram is a map where the geometry is distorted proportionally to the value of some variable. The {cartogram} package have functions for doing this.
