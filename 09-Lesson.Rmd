...
Package {stars} provides functions and methods for working with space-time data. To see what methods for class `stars` are available we use the `methods()` function.
``` {r}
library(stars)
library(tidyverse)
