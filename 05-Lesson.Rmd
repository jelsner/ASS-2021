...
The {ggplot2} package is the most frequently used visualization tool among data scientists. It is used extensively including the New York Times and 538. It's popular because it is built on the theoretical principles of good data visualization.
...
Torn.df %>% 
  ...
  filter(!st %in% c("DC", "PR", "VI")) %>%
ggplot(aes(as.factor(Month), nT)) +
