...
I'm declaring this Friday to be a mid semester wellness day for this class. No lesson and no assignment!

## Using other neighborhood definitions to estimate autocorrelation

Last time we learned how to compute autocorrelation on areal aggregated data. The procedure involves a weights matrix, which we created using default settings for the neighborhood definition and the weighting scheme. Other neighborhood definitions are possible.
